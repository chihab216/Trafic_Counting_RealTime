...
def get_bounding_boxes(image):
    # get object classes
    classes = {14: 'background',
                7: 'aeroplane', 0: 'bicycle', 6: 'bird', 4: 'boat',
                5: 'bottle', 3: 'bus', 1: 'car', 8: 'cat', 9: 'chair',
                10: 'cow', 11: 'diningtable', 12: 'dog', 13: 'horse',
                2: 'motorbike', 15: 'person', 16: 'pottedplant',
    ...
    prototxt = os.path.join(__location__, "C:/Users/Lenovo/Desktop/Vehicle-Counting-master/detectors/ssd/models/VGGNet/VOC0712/SSD_300x300/deploy.prototxt")
    weights = os.path.join(__location__, "C:/Users/Lenovo/Desktop/Vehicle-Counting-master/detectors/ssd/models/VGGNet/VOC0712/SSD_300x300/VGG_VOC0712_SSD_300x300_iter_120000.caffemodel")
    ...
    for i in range(detections.shape[2]):
        ...
        if confidence > 0.2 and class_id in classes and classes[class_id] in classes_of_interest:
            ...
            x, y, w, h, g = x_bottom_left, y_bottom_left, x_top_right - x_bottom_left, y_top_right - y_bottom_left,int(class_id)
            bounding_boxes.append([x, y, w, h, g])
